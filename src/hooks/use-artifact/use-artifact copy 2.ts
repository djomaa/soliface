...
//     logger.debug('Checking..', { signatureHash, actualHash, hash })
//     if (!name || !rawAbi || actualHash.loading) {
//       logger.debug('Empty');
//       return;
//     }
...
//   }, [name, rawAbi, actualHash, corruptionReason]);
